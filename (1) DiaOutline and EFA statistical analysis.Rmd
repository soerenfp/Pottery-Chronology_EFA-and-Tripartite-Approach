...
#NOTE: stack(allDiatomOutlines) now there is one vessel being really large and the rest is pretty small. I need to change that before uploading it to DiaOutline
