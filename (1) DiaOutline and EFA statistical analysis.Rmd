...
#...but if I run the following chunk I get my three Trial trace.txt files in a coordinate system!
# stack(allDiatomOutlines)
stack(coo_center(allDiatomOutlines))

#But then comes the next problem below
