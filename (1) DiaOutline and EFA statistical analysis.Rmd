...
####((2)) Create a Data Set from .txt DiaOutline file
```{r, echo=TRUE}
DiaOutlineDataset <- as.matrix(read.table("C:/Program Files/DiaOutline_working directory/DiaOutline_trial trace 01.txt", sep = "", header = FALSE))
```
...
#Following chunk is by me

lf <- list.files("C:/Program Files/DiaOutline_working directory/", pattern = "\\DiaOutline_trial trace 01.txt", full.names=TRUE)

#Problem comes below: "Error in table(lfl) : nothing to tabularise" 

lf1<-lf_structure(lf,  split = "C:/Program Files/DiaOutline_working directory/", trim.extension = FALSE)
